...
PPC_FUNC_IMPL(__imp__sub_822229F0) {
	...
	case 0:
		...
		return;
	case 1:
		sub_82222A3C(ctx, base);
		return;
	case 2:
		sub_82222A80(ctx, base);
		return;
	case 3:
		sub_82222A90(ctx, base);
		return;
	case 4:
		sub_82222AD4(ctx, base);
		return;
	default:
		__builtin_unreachable();
	}
...
PPC_FUNC_IMPL(__imp__sub_82222CD8) {
	...
	switch (ctx.r4.u64) {
	case 0:
		sub_82222D2C(ctx, base);
		return;
	case 1:
		sub_82222D24(ctx, base);
		return;
	case 2:
		sub_82222D1C(ctx, base);
		return;
	case 3:
		// ERROR: 0x82222D14
		return;
...
PPC_FUNC_IMPL(__imp__sub_82223468) {
	...
	case 1:
		...
		return;
	case 2:
		sub_82223628(ctx, base);
		return;
	case 3:
		sub_82223630(ctx, base);
		return;
	case 4:
		sub_82223638(ctx, base);
		return;
	case 5:
		sub_82223640(ctx, base);
		return;
	case 6:
		sub_82223648(ctx, base);
		return;
	case 7:
	...
	case 99:
		...
		return;
	case 100:
		sub_82223668(ctx, base);
		return;
	case 101:
		sub_82223670(ctx, base);
		return;
	default:
		__builtin_unreachable();
	}
...
loc_82224A9C:
	...
	switch (ctx.r11.u64) {
	case 0:
		sub_82224DB4(ctx, base);
		return;
	case 1:
		sub_82224DA8(ctx, base);
		return;
	case 2:
		sub_82224D9C(ctx, base);
		return;
	case 3:
		sub_82224D90(ctx, base);
		return;
	case 4:
		sub_82224D84(ctx, base);
		return;
	case 5:
		sub_82224D78(ctx, base);
		return;
	case 6:
		sub_82224C04(ctx, base);
		return;
	case 7:
		sub_82224D6C(ctx, base);
		return;
	case 8:
		sub_82224D60(ctx, base);
		return;
	case 9:
		sub_82224D54(ctx, base);
		return;
	case 10:
		sub_82224D48(ctx, base);
		return;
	case 11:
		sub_82224D3C(ctx, base);
		return;
	case 12:
		sub_82224D30(ctx, base);
		return;
	case 13:
		sub_82224D24(ctx, base);
		return;
	case 14:
		sub_82224D18(ctx, base);
		return;
	case 15:
		sub_82224D0C(ctx, base);
		return;
	case 16:
		sub_82224D00(ctx, base);
		return;
	case 17:
		sub_82224CF4(ctx, base);
		return;
	case 18:
		sub_82224CE8(ctx, base);
		return;
	case 19:
		sub_82224BE0(ctx, base);
		return;
	case 20:
		sub_82224CDC(ctx, base);
		return;
	case 21:
		sub_82224CD0(ctx, base);
		return;
	case 22:
		sub_82224CC4(ctx, base);
		return;
	case 23:
		sub_82224C1C(ctx, base);
		return;
	case 24:
		sub_82224CB8(ctx, base);
		return;
	case 25:
		sub_82224CAC(ctx, base);
		return;
	case 26:
		sub_82224CA0(ctx, base);
		return;
	case 27:
		sub_82224C94(ctx, base);
		return;
	case 28:
		sub_82224C10(ctx, base);
		return;
	case 29:
		sub_82224C88(ctx, base);
		return;
	case 30:
		sub_82224C7C(ctx, base);
		return;
	case 31:
		sub_82224BF8(ctx, base);
		return;
	case 32:
		sub_82224C70(ctx, base);
		return;
	case 33:
		sub_82224C64(ctx, base);
		return;
	case 34:
		sub_82224C58(ctx, base);
		return;
	case 35:
		sub_82224C4C(ctx, base);
		return;
	case 36:
		sub_82224C34(ctx, base);
		return;
	case 37:
		sub_82224C40(ctx, base);
		return;
	case 38:
		sub_82224C34(ctx, base);
		return;
	case 39:
		sub_82224C28(ctx, base);
		return;
	case 40:
		sub_82224C1C(ctx, base);
		return;
	...
	case 48:
		...
		return;
	case 49:
		sub_82224BD4(ctx, base);
		return;
	case 50:
		sub_82224BC8(ctx, base);
		return;
	case 51:
		sub_82224BBC(ctx, base);
		return;
	case 52:
		sub_82224DC0(ctx, base);
		return;
	case 53:
		sub_82224BB0(ctx, base);
		return;
	case 54:
		// ERROR: 0x82224BA4
		return;
