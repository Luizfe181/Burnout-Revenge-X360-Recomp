...
PPC_FUNC_IMPL(__imp__sub_821EA1F0) {
	...
	case 0:
		...
		return;
	case 1:
		sub_821EA24C(ctx, base);
		return;
	case 2:
		sub_821EA268(ctx, base);
		return;
	case 3:
		sub_821EA284(ctx, base);
		return;
	case 4:
		sub_821EA2A0(ctx, base);
		return;
	case 5:
		sub_821EA2BC(ctx, base);
		return;
	default:
		__builtin_unreachable();
	}
...
PPC_FUNC_IMPL(__imp__sub_821EBFB0) {
	...
	case 0:
		...
		return;
	case 1:
		sub_821EC01C(ctx, base);
		return;
	case 2:
		sub_821EC02C(ctx, base);
		return;
	case 3:
		sub_821EC03C(ctx, base);
		return;
	case 4:
		sub_821EC04C(ctx, base);
		return;
	case 5:
		sub_821EC05C(ctx, base);
		return;
	default:
		__builtin_unreachable();
	}
