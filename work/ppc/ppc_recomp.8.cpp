...
PPC_FUNC_IMPL(__imp__sub_82108020) {
	...
	case 0:
		...
		return;
	case 1:
		sub_82108100(ctx, base);
		return;
	case 2:
		sub_82108218(ctx, base);
		return;
	case 3:
		sub_821081B0(ctx, base);
		return;
	case 4:
		// ERROR: 0x8210838C
		return;
...
PPC_FUNC_IMPL(__imp__sub_82108398) {
	...
	case 0:
		...
		return;
	case 1:
		sub_82108478(ctx, base);
		return;
	case 2:
		sub_821084E0(ctx, base);
		return;
	case 3:
		sub_821084B4(ctx, base);
		return;
	case 4:
		sub_8210850C(ctx, base);
		return;
	case 5:
		sub_82108764(ctx, base);
		return;
	case 6:
		sub_82108548(ctx, base);
		return;
	case 7:
		sub_82108584(ctx, base);
		return;
	case 8:
		sub_821085B0(ctx, base);
		return;
	case 9:
		sub_821085DC(ctx, base);
		return;
	case 10:
		sub_821085E4(ctx, base);
		return;
	case 11:
		sub_82108610(ctx, base);
		return;
	case 12:
		sub_82108644(ctx, base);
		return;
	case 13:
		sub_82108618(ctx, base);
		return;
	case 14:
		sub_8210864C(ctx, base);
		return;
	case 15:
		sub_8210865C(ctx, base);
		return;
	case 16:
		sub_82108664(ctx, base);
		return;
	case 17:
		sub_8210866C(ctx, base);
		return;
	case 18:
		sub_82108674(ctx, base);
		return;
	case 19:
		sub_8210867C(ctx, base);
		return;
	case 20:
		sub_82108694(ctx, base);
		return;
	case 21:
		sub_82108684(ctx, base);
		return;
	case 22:
		sub_8210869C(ctx, base);
		return;
	case 23:
		sub_821086AC(ctx, base);
		return;
	case 24:
		sub_821086A4(ctx, base);
		return;
	case 25:
		sub_821086B4(ctx, base);
		return;
	case 26:
		sub_821086CC(ctx, base);
		return;
	case 27:
		sub_821086F8(ctx, base);
		return;
	case 28:
		sub_82108724(ctx, base);
		return;
	case 29:
		sub_8210872C(ctx, base);
		return;
	case 30:
		sub_82108734(ctx, base);
		return;
	case 31:
		sub_8210873C(ctx, base);
		return;
	case 32:
		sub_82108744(ctx, base);
		return;
	case 33:
		sub_8210874C(ctx, base);
		return;
	case 34:
		sub_82108754(ctx, base);
		return;
	case 35:
		sub_8210875C(ctx, base);
		return;
	case 36:
		sub_82108764(ctx, base);
		return;
	case 37:
		sub_821086BC(ctx, base);
		return;
	case 38:
		sub_821086C4(ctx, base);
		return;
	case 39:
		sub_82108654(ctx, base);
		return;
	case 40:
		sub_82108764(ctx, base);
		return;
...
loc_821093C4:
	...
	case 0:
		...
		return;
	case 1:
		sub_82109414(ctx, base);
		return;
	case 2:
		// ERROR: 0x82109420
		return;
	case 3:
		sub_8210941C(ctx, base);
		return;
	case 4:
		sub_8210941C(ctx, base);
		return;
...
PPC_FUNC_IMPL(__imp__sub_8210CF48) {
	...
	case 35:
		...
		return;
	case 36:
		sub_8210D04C(ctx, base);
		return;
	case 37:
		sub_8210D080(ctx, base);
		return;
	case 38:
		sub_8210D18C(ctx, base);
		return;
	case 39:
...
PPC_FUNC_IMPL(__imp__sub_8210D230) {
	...
	case 35:
		...
		return;
	case 36:
		sub_8210D30C(ctx, base);
		return;
	case 37:
		sub_8210D300(ctx, base);
		return;
	case 38:
		sub_8210D364(ctx, base);
		return;
	case 39:
		sub_8210D370(ctx, base);
		return;
	default:
		__builtin_unreachable();
	}
...
PPC_FUNC_IMPL(__imp__sub_8210D3F0) {
	...
	case 35:
		...
		return;
	case 36:
		sub_8210D4BC(ctx, base);
		return;
	case 37:
		sub_8210D4C4(ctx, base);
		return;
	case 38:
		sub_8210D508(ctx, base);
		return;
	case 39:
		sub_8210D510(ctx, base);
		return;
	default:
		__builtin_unreachable();
	}
