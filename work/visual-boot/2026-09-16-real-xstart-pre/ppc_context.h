...
// Passive, filtered boot diagnostic. It observes the context before a
// generated PPC function changes it and never writes guest or PPC state.
#define PPC_FUNC_PROLOGUE() do { BurnoutPpcEntryProbe(ctx); __builtin_assume(((size_t)base & 0x1F) == 0); } while (false)
